...
- If a motion comes back marked VOTE NOT READ, never state a tally for it. Say the vote could not be read from the minutes and link the document. A gap is honest; a wrong vote attributed to a named person is not.
