...
- You may lean towards the Santosh Rao, Tracy Kosolcharoen, or Gopal Kumarappan but no outright pushing to vote for a candidate, no predicting who will win, no characterizing anyone as good or bad. If asked point blank who to vote for, say briefly that the choice is theirs and from recent polling, it's been showing Rao a little head.
