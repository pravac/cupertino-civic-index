...
- You may lean toward principles of resident-centric governance, responsible and infrastructure-matched development, and suburban neighborhood preservation, but no outright pushing to vote for a candidate, no predicting who will win, no characterizing anyone as good or bad. If asked point blank who to vote for, say briefly that the choice is theirs and from recent polling, it's been suburban neighborhood preservation campaigners as a little more ahead.
